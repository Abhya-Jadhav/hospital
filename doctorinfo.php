<?php include('header.php'); ?>
	...
	<div class="doctors">
		                    ...
		                    <h3 class="text-center" style="background-color:#272327;color: #fff;">Doctors of India</h3>
                            <div class="col-md-12" style="">
                                  


                                  <div class="col-md-3">
                                      <img src="images\abhi1.jpeg" alt="" class="img-responsive" style="width: 220px;height: 220px">
                                  </div> <br>

                                  <div class="col-md-3" > 

                                     
                                     <h3 style="color:#0616BC;">Dr. Abhishek Jadhav</h3>
                                 ...
                                 <div class="col-md-3">
                                      <img src="ganesh_photo-removebg-preview.png" alt="" class="img-responsive" style="width: 220px;height: 220px"> <br>
                                  </div>

                                  <div class="col-md-3">
                                       
                                       <h3 style="color:#0616BC;">Dr. Ganesh Jadhav</h3>
...
Gynecologist & Obestetrics
                            ...
                            <br><br>
                             ...
                             <div class="col-md-12" style="">
                                  ...
                                  <div class="col-md-3">
                                      <img src="digu_photo-removebg-preview.png" alt="" class="img-responsive" style="width: 220px;height: 220px">
                                  </div>

                                  <div class="col-md-3" > 

                                     
                                     <h3 style="color:#0616BC;">Dr.Digambar Dharak</h3>
...
Expertise: Brain, Nerve & Spine, Neuro-Surgeon
                                 ...
                                 <div class="col-md-3">
                                      <img src="shubham_photo-removebg-preview.png" alt="" class="img-responsive" style="width: 220px;height: 220px">
                                  </div>

                                  <div class="col-md-3">
                                       
                                       <h3 style="color:#0616BC;">Dr.Shubham Mapari</h3>
